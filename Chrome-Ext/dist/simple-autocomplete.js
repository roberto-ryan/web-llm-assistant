  ...
  (() => {
    var SimpleAutocomplete = class {
      ...
      getSuggestions(query) {
        ...
        const filteredElements = query ? elements.filter((el) => el.name.toLowerCase().includes(query.toLowerCase())) : elements;
      ...
      insert(suggestion) {
        ...
        if (suggestion.type === "cmd") {
          const newValue2 = beforeTrigger + afterCursor;
          this.inputElement.value = newValue2;
